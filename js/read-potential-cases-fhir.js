...
(async () => {
  ...
  await fs.writeFile("severe-mental-illnesses-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("severe-mental-illnesses-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
